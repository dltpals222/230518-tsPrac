 ...
 * @return {object} 중복된요소와 바뀔요소를 담은 객체
 * 
...
function diffFinder(targetArray:string[], compareArray:string[], originalArray:string[]):{} {
  ...
  // 리턴 부분에서는 가독성을 위해 객체의 키값을 지역변수 이름과 동일하게 지정하였지만,
...
const pokemon :string[] = ['피키츄','라이츄','파이리','꼬부기']
